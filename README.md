...
* Clopay Trailer tracking with Expected, Arrived, and Dispatched statuses, searchable PDF/Excel attachments, arrival email templates, and issue photos.
* Downloadable PDF reports for Receiving, Shipped Out, Customer Pick Up, and Clopay Trailer records.
